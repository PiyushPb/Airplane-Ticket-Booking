  ...
  return (
    <div className="cursor-pointer">
      ...
      <div className="absolute bottom-[50px] md:top-[100px] left-[20px] md:left-[50px]">
        ...
        <p className="text-white mt-2 md:mt-3 text-[14px] md:text-lg font-light">
          {props.subheading}
        </p>
        <button className="bg-white text-black mt-3 px-8 py-3 rounded-xl hover:bg-gray-300 transition duration-200">
          Book now
        </button>
      </div>
    </div>
